...
//            MixAlgorithms.IncreaseValue(node.Data, buff);
...
//        //MixAlgorithms.IncreaseValue(node.Data, graphWeight);
//        MixAlgorithms.IncreaseValue(node.Data, node.Data.Weight);
...
//            UnityEngine.Debug.Log($"[SpellGraphSlover] num: {node.num}, num: {node.Data.Weight}");
//        }
